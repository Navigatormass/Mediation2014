...
/****** Object:  StoredProcedure [dbo].[uspPrintFirstLetter]    Script Date: 02/10/2015 12:09:13 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[uspPrintFirstLetter]
...
WHERE     (dbo.MediationCaseInformation.FirstLetterSentDate IS NULL) ORDER BY MediationCaseInformation.MediationCaseInformationID ASC
    /* SET NOCOUNT ON */
    RETURN
GO
