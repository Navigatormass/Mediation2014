...
/****** Object:  StoredProcedure [dbo].[uspRePrintNoResponse]    Script Date: 02/10/2015 12:13:28 ******/
SET ANSI_NULLS ON
GO
...
CREATE  PROCEDURE [dbo].[uspRePrintNoResponse]
...
FROM         dbo.MediationCaseInformation INNER JOIN
                      ...
                      -- (dbo.MediationCaseInformation.CertificateNoticePrintDate IS NULL) AND 
                       (dbo.MediationCaseInformation.ConfCallDeadlineDate < GETDATE() - 1) AND 
