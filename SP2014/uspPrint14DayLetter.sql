...
/****** Object:  StoredProcedure [dbo].[uspPrint14DayLetter]    Script Date: 02/10/2015 12:08:14 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[uspPrint14DayLetter]
...
WHERE     (dbo.MediationCaseInformation.MediationInvoiceID > 0) AND ---(dbo.MediationCaseInformation.MedInvoiceLetterDate IS NULL) AND 
                      ...
                      AND (dbo.MediationCaseInformation.ActualConferenceDate IS NOT NULL)  AND dbo.MediationCaseInformation.MediationCaseInformationID=@MediationCaseInformationID
