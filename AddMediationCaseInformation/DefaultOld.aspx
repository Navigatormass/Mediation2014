                ...
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pBody2" runat="server" CssClass="cpBody">
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceCertificateNotice" runat="server" ConnectionString="<%$ ConnectionStrings:Mediation2014ConnectionString %>"
                            SelectCommand="SELECT CertificateNoticeID, ISNULL(NoticeReasonDesc, '') + ISNULL(', ' + NoticeTypeDesc, '') AS Name FROM CertificateNotice UNION SELECT NULL AS Expr1, '--- Select One ----' AS Expr2 ORDER BY CertificateNoticeID"></asp:SqlDataSource>
