<%@ Page Title="" Language="C#" MasterPageFile="~/MediationMasterPage.master" AutoEventWireup="true" CodeFile="FirstSentLetter.aspx.cs" Inherits="SpecificTask_FirstSentLetter" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="header2">
          To begin printing  the First letter&nbsp;&nbsp;<asp:Label
     ...
     <asp:Table ID="Table1" runat="server" Width="95%"  >
            ...
            <%--    <asp:TableCell>--%>
               <%-- <asp:Button ID="btnSearch" runat="server" CssClass="buttonSave" 
                    ...
                    <asp:TableCell>
                  &nbsp; &nbsp;&nbsp; &nbsp&nbsp; &nbsp&nbsp; &nbsp&nbsp; &nbsp<asp:Button ID="btnPrint" runat="server" Text="Print First Letters"  Width="170px" OnClick="btnPrint_Click"  ToolTip="Print First Letters"
                    CssClass="button" CausesValidation="False" TabIndex="3"  PostBackUrl="~/SpecificTask/FirstSentLetter.aspx" />
 ...
 <%-- <%--   ReportSourceID="CrystalReportSource1"--%>
    ...
    <%-- <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="~\Report\CrystalReports\MediationFirstLetter.rpt">
        </Report>
